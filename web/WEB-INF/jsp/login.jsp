...
<header class="header">
    <div class="container-fluid navbar headerTop">
        ...
        <div class="headerBtn col-lg-2 col-md-2 col-sm-3 hidden-xs col-lg-offset-6 col-md-offset-6">
            ...
            <p class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">Forgot password?</p>
        </div>
    </div>
...
<div class="content container">
    <h1 class="col-lg-12 col-md-12 col-sm-12 col-xs-12">NetCracker Courses Application Form</h1>
    <img class="col-lg-8 col-md-8 hidden-sm hidden-xs" src="/resources/images/main.jpg" />
